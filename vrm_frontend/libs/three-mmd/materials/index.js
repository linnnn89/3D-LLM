...
import { n as resolveMMDAlphaPolicy, r as resolveMMDTextureAlphaMode, t as applyMMDAlphaPolicy } from "../alpha-policy-aafr_Rse.js";
import { Vector4 } from "three";
//#region src/materials/morph.ts
const createMMDMaterialEvaluatedState = (descriptor) => ({
...
const addVector4 = (vector, value, weight) => {
...
const applyMMDMaterialMorph = (state, element, weight) => {
	if (element.type === 0) {
...
//#endregion
export { applyMMDAlphaPolicy, applyMMDMaterialMorph, createMMDMaterialEvaluatedState, isMMDMaterial, resolveMMDAlphaPolicy, resolveMMDTextureAlphaMode };
